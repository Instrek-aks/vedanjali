...
export const MOCKUP_APP_DELIVERY = '/l2.jpeg';
export const MOCKUP_APP_PAYMENT = '/len.jpeg';

export const PORTFOLIO_TAKEOFFNOW = '/images/portfolio-takeoffnow.svg';
export const PORTFOLIO_ASHIRWAD = '/images/portfolio-ashirwadplastics.svg';
export const PORTFOLIO_LEGAL = '/images/portfolio-legalolympiad.svg';

export const MOCKUP_ERP_LAPTOP = '/images/mockup-erp-laptop.svg';
export const MOCKUP_CRM_BROWSER = '/images/mockup-crm-browser.svg';
export const MOCKUP_HRM_BROWSER = '/images/mockup-hrm-browser.svg';

export const SYSTEM_RESTAURANT_ORDERING = '/images/system-restaurant-ordering.svg';
export const SYSTEM_KITCHEN_ANALYTICS = '/images/system-kitchen-analytics.svg';
export const SYSTEM_ECOMMERCE_STORE = '/images/system-ecommerce-store.svg';
export const SYSTEM_GROCERY_ADMIN = '/images/system-grocery-admin.svg';
export const SYSTEM_CLINIC_PLATFORM = '/images/system-clinic-platform.svg';
export const SYSTEM_GYM_MANAGEMENT = '/images/system-gym-management.svg';
